...
local DinoWindow = Dino:CreateWindow("sazx hub")
...
Home:CreateButton("fram point *หยุดไม่ได้*",function()
    while true do
wait()
...
Home:CreateButton("fram Gem*หยุดไม่ได้*", function()
